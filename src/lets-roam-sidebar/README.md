...
- **Drag-to-Reorder**: Hover over a stacked block's breadcrumb to reveal a drag handle (grip icon). Drag any stacked block up or down to reorder it within the sidebar. A blue insertion line indicates the exact drop position, preventing visual ambiguity.
