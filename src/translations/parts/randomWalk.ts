export default {
  ...
  "No children in this block group.": "此分组下没有子节点。",
  "Reshuffled items.": "已重新洗牌子节点。",
  "No random walk groups found. Add tag ": "未找到漫步分组，请在块上添加标签 ",
  "Query Group": "查询分组",
  "Unnamed Group": "未命名分组",
  "No groups found": "未找到漫步分组",
  "Random Walk": "随机漫步",
  "Random Walk Settings": "随机漫步设置",
  "Walk Tag": "漫步标签",
