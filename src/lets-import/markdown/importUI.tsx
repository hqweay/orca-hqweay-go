...
import type { ImportOptions, ImportResult, MarkdownFile } from './markdownImporter'
...
export function FolderSelector({ onFolderSelect, onCancel }: FolderSelectorProps) {
      ...
      <div className="folder-selector">
        ...
        <div className="selector-content">
          <div className="folder-path-input">
            <label>Choose a folder containing markdown files:</label>
          </div>
