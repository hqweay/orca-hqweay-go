...
- **`.agent/rules/orca-note-rule.md`**: For agent behavioral constraints and development workflows.
...
├── CONTEXT.md
├── docs/adr/
│   ├── 0001-sub-plugin-settings-architecture.md
│   └── 0002-dual-track-search-sync.md
└── src/
```
